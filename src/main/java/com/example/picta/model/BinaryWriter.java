...
public class BinaryWriter {
    ...
    public static void writeObject(ArrayList<Sequential> seqList) throws IOException {
        FileOutputStream fos  = new FileOutputStream("src/main/java/com/example/picta/data.bin");
    ...
    public static ArrayList<Sequential> readObject() throws IOException, ClassNotFoundException {
        File file = new File("src/main/java/com/example/picta/data.bin");
        ...
        FileInputStream fis = new FileInputStream("src/main/java/com/example/picta/data.bin");
